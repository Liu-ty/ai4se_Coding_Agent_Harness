...
var allowedTransitions = map[RunState]map[RunState]bool{
	StateCreated:            {StatePreflight: true, StateStopped: true},
	StatePreflight:          {StateBaselineValidating: true, StateDeciding: true, StateAwaitingApproval: true, StateStopped: true},
	...
	StateAwaitingApproval:   {StatePreflight: true, StateExecuting: true, StateDeciding: true, StateStopped: true},
